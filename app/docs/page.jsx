            ...
            {!isInitialized ? (
              ...
              <>
                ...
                <div className="grid grid-cols-4 gap-6">
                  {docs.map((i) => (
                    <Link key={i.id} href={`/chat/${i.ipfsHash}`} className="w-full bg-white shadow rounded-md group hover:shadow-xl transition-all">
                      <div className="w-full aspect-[3/1] bg-neutral-800 flex items-center justify-center rounded-t-md">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-white group-hover:text-lime-400">
                          <path
                            strokeLinecap="round"
                      ...
                      <div className="p-3">
                        <h6 className="line-clamp-1 text-sm font-medium">{i.name}</h6>
                      </div>
                    </Link>
                  ))}
                </div>
